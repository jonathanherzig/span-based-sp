...
@TrainerBase.register("weak_sup_trainer", constructor="from_partial_objects")
class Trainer(TrainerBase):
    def __init__(
        ...
        optimizer : `torch.nn.Optimizer`, required.
            An incktance of a Pytorch Optimizer, instantiated with the parameters of the
    ...
    def batch_loss(self, batch: TensorDict, for_training: bool) -> torch.Tensor:
        ...
        try:
            ...
            effective_batch_size = output_dict["effective_batch_size"] if "effective_batch_size" \
                                                                          in output_dict else None
        except KeyError:
            if for_training:
                raise RuntimeError(
